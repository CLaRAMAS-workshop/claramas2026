...
<table>
    <tr>
        <td width="25%"><img src="../assets/img/people/stefano_mariani.png"></td>
        <td width="60%">Dr. <strong>Stefano Mariani</strong> 👋<br>
            <em>Department of Science and Methods of Engineering</em> <br> 
            <em>University of Modena and Reggio Emilia</em> <br>
            Reggio Emilia, Italy</td>
        <td width="15%"> 🌐 <a href="https://smarianimore.github.io">website</a> <br> 
            📫 <a href="mailto:stefano.mariani@unimore.it">email</a> </td>
    </tr>
    <tr>
        <td width="25%"><img src="../assets/img/people/Andre_Meyer_Vitali.jpeg"></td>
        <td width="60%">Dr. <strong>André Meyer-Vitali</strong> 👋<br>
            <em>Deutsches Forschungszentrum für Künstliche Intelligenz GmbH</em> <br>
            Saarbrücken, Germany</td>
        <td width="15%"> 🌐 <a href="https://www.dfki.de/en/web/about-us/employee/person/anme08">website</a> <br> 
            📫 <a href="mailto:andre.meyer-vitali@dfki.de">email</a> </td>
    </tr>
    <tr>
        <td width="25%"><img src="../assets/img/people/julien_siebert.jpeg"></td>
        <td width="60%">Dr. <strong>Julien Siebert</strong> 👋<br>
            <em>Data Science Department</em> <br>
            <em>Fraunhofer Institute for Experimental Software Engineering</em> <br>
            Kaiserslautern, Germany</td>
        <td width="15%"> 🌐 <a href="https://www.iese.fraunhofer.de/blog/author/julien-siebert/">website</a> <br> 
    ...
    <tr>
        ...
        <td width="15%"> 🌐 <a href="https://www.uu.nl/staff/MMDastani">website</a> <br> 
